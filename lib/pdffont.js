...
//        nodeUtil.p2jinfo"typeName = " + typeName + " => faceIdx = " + this.faceIdx);
    ...
    cls.prototype.processText = function (p, str, maxWidth, color, fontSize, targetData, matrix2D, wordSpacing, spaceWidth) {
        ...
        var oneText = {
            ...
            w: PDFUnit.toFormX(maxWidth * 10, 5), //TODO find where this *10 is comming from
            clr: clrId,
            A: "left",
            ws: wordSpacing,
            sw: PDFUnit.toFormX(spaceWidth * 10, 5), //TODO find where this *10 is comming from
            R: [{
