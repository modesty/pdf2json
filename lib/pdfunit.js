...
var PDFUnit = (function PFPUnitClosure() {
    ...
    cls.toFixedFloat = function(fNum, precision) {
        return parseFloat(fNum.toFixed(precision || 3))
    };
    ...
    cls.toFormX = function(viewportX, precision) {
        return cls.toFixedFloat(viewportX / _pixelXPerGrid, precision);
    };
