...
var PDFPageParser = (function () {
    ...
    cls.prototype.parsePage = function(callback, errorCallBack) {
        ...
        // The canvas is available in the context where texts/fonts are processed (Texts array in pdf2json output),
        // add viewport info about width, height and the PDF view (view is an array where indices 2 and 3 contain the
        // PDFs post script points in x and y dimension.
        renderContext.canvasContext.canvas.viewportInfo = {
            width: this.viewport.width,
            height: this.viewport.height,
            pageView: self.pdfPage.view
        }
