    ...
    getRawTextContent() {
        ...
        this.rawTextContents.forEach( (textContent, index) => {
            ...
            textContent.bidiTexts.forEach( (textObj, idx) => {
	            if (prevText) {
			    // why we use line height parameters instead of check X coords
			    // if (prevText.x > textObj.x) {
			    // this is may be better then hardcode values if somebody use very small fontsize?
