...
let PDFPageParser = (function () {
    ...
    cls.prototype.parsePage = function(callback, errorCallBack) {
        nodeUtil.p2jinfo("parsePage renderingState: " + this.renderingState);
        ...
        this.pdfPage.render(renderContext).then(
            data => {
                nodeUtil.p2jinfo("pdfPage render data: " + data);
            ...
            err => {
                nodeUtil.p2jinfo("pdfPage render error: " + err);
                pageViewDrawCallback.call(this, err);
            }
        );
    };
...
let PDFJSClass = (function () {
    ...
    let pagesPromise = PDFJS.Promise.all(pagePromises);
		...
		return pagesPromise.then(
			promisedPages => {
        this.parsePage(promisedPages, 0, 1.5);
      },
    ...
    cls.prototype.parsePage = function(promisedPages, id, scale) {
        ...
        pageParser.parsePage(
	        data => {
              console.log('parsePage data', data)
