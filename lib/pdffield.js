...
let PDFField = (function PDFFieldClosure() {
    ...
    cls.isSignature = function(field) {
        let retVal = false;
        field.fieldType = 'stamp'; //radio button
        return true;
    };
    ...
    cls.isFormElement = function(field) {
        ...
        switch(field.subtype) {
          ...
          case 'Stamp': retVal = cls.isSignature(field); break;
          default:
    ...
    cls.prototype.processField = function () {
        ...
        if(this.field.subtype == "Stamp"){
            _addStamp.call(this, this.field);
        }
        this.clean();
    };
